                                    ...
                                    <div className="flex flex-col gap-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="min-w-0">
                                                <div className="md:text-xl text-base mt-1 font-semibold text-[#0a1628]">{capitalize(venta.equipoLocal)} vs {capitalize(venta.equipoVisitante)}</div>
                                                {/* <div className="text-sm text-[#7a8fa6] mt-0.5">
                                                    <i className="fa-solid fa-location-dot" /> {venta.nombreEstadio} ({venta.nombreSector})
                                                </div> */}
