...
import getMyEntradasRegistred from '../../../../services/EntradaService/getMyEntradasRegistred'

export default function TicketsRegistred() {
  const [entradas, setEntradas] = useState([])

  const loadEntradas = async () => {
    try {
      const data = await getMyEntradasRegistred()
      console.log(data)
      ...
      <div className="text-xl">
        <div className="sm:flex justify-between sm:items-end items-start w-full pb-4">
          <h1 className="font-sans text-3xl font-bold text-[#0a1628] uppercase tracking-wide leading-none">
            Entradas <span className="text-[#c8a84b]"> registradas</span>
          </h1>
        </div>
              ...
              return (
                <div
                  ...
                  <div className="flex md:hidden flex-col gap-3">
                    ...
                    <div className="flex gap-2 border-t border-[#eaf0f8] pt-2.5"></div>
                  </div>
