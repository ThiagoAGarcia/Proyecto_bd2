    ...
    <>
      ...
      <div className="w-full h-screen bg-[#0a1628] flex md:flex-row flex-col justify-center items-center">
        ...
        <form
          ...
          <h1 className="text-4xl text-black font-semibold">Iniciar sesión</h1>
          ...
          <div className="w-full flex flex-col justify-start items-start mt-10">
            ...
            <div className="w-full flex justify-center items-center mt-5">
              <span>
                ...
                <a
                  href="/register"
                  className="border-b font-bold hover:border-b-0">
                  REGISTRARSE
                </a>
              </span>
            </div>
            <div className="w-full flex justify-center items-center mt-3"></div>
          </div>
        </form>
        <button
